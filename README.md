...
__Tutorial__
  ...
  You can run the jupyter notebook of `CellAssignment.ipynb` and `PredictGenes.ipynb` to reproduce the results of figure2&4 in our paper. If you want to analysis your own data, the `doc/Tutorial.ipynb` is an example showing how to use them to predict new spatial gene patterns and cell locations.
